...
void UABHUDWidget::BindCharacterStat(class UABCharacterStatComponent* CharaterStat)
{
	ABCHECK(nullptr != CharaterStat);
	CurrentCharacterStat = CharaterStat;
	CharaterStat->OnHPChanged.AddUObject(this, &UABHUDWidget::UpdateCharacterStat);
}
